...
from serviceApp.scripts.instagram import InstagramOauthClient, searchForLocation
...
class TwitterTests(unittest.TestCase):
	...
	def test_TwitterOauthClient(self):
		with patch('serviceApp.scripts.instagram.requests') as mock_requests:
	...
	def test_searchForLocation(self):
		with patch('serviceApp.scripts.instagram.searchForLocation') as mock_searchForLocation:
