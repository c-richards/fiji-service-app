...
from serviceApp.serializers import SnippetSerializer
from serviceApp.forms import UserForm
...
def api_examples(request):
    ...
    return render(request, 'serviceApp/api_examples.html', context)
...
def steam(request):
    ...
    return render(request,'serviceApp/steam.html', {"game": game })
...
def facebook(request):
    ...
    '''
    userInfo = getFacebook.get_user_info()
    return render(request, 'serviceApp/facebookAPIExample.html', { 'userInfo' : userInfo})
...
def googlePlus(request):
    ...
    userInfo = getGoogle.get_user_info()
    return render(request, 'serviceApp/googlePlus.html', {'userInfo' : userInfo})
...
def dropbox(request):
    userInfo = getDropbox.get_user_info()
    return render(request, 'serviceApp/dropbox.html', {'userInfo' : userInfo})
...
def dropboxSearchFile(request):
    if request.method == 'POST':
        ...
        return render(request, 'serviceApp/dropboxSearchFile.html', {'data': response.json()})
...
def foursquare(request):
    userInfo = getFoursquare.get_user_info()
    return render(request, 'serviceApp/foursquare.html', {'data' : userInfo})
...
def yelp(request):
    ...
    return render(request, 'serviceApp/yelp.html', { 'data': data })
...
def meetup(request):
    REDIRECT_URI = 'http://127.0.0.1:8000/serviceApp/meetupToken'
...
def meetupToken(request):
    ...
    return HttpResponseRedirect('http://127.0.0.1:8000/serviceApp/meetupUser/')

def meetupUser(request):
    if not MeetupToken.objects.all().exists():
        return HttpResponseRedirect('http://127.0.0.1:8000/serviceApp/meetup')
    ...
    return render(request, 'serviceApp/meetup.html', { 'data': meetupData })
...
def quandlstocks(request):
    ...
    return render(request, 'serviceApp/quandl.html', { 'everyData': everyData })
...
def nytimesarticles(request):
    ...
    return render(request, 'serviceApp/nytimes.html', { 'everyData': everyData })
...
def githubTopRepositories(request):
    ...
    if request.method == 'POST':
        ...
        print parsedData
    return render(request, 'serviceApp/githubTopRepositories.html', {'data': parsedData})
...
def githubResume(request):
    ...
    return render(request, 'serviceApp/githubResume.html', { 'data': allData })
...
def tumblr(request):
    ...
    return render(request, 'serviceApp/tumblr.html', context)
...
def instagram(request):
    ...
    return render(request, 'serviceApp/instagram.html', context)
...
def instagramMediaByLocation(request):
    ...
    return render(request, 'serviceApp/instagram_q.html', context)
...
def twitter(request):
    ...
    return render(request, 'serviceApp/twitter.html', context)
...
def twitterTweets(request):
    ...
    return render(request, 'serviceApp/twitter_tweet.html', context)
...
def linkedin(request):
    ...
    return render(request, 'serviceApp/linkedin.html', context)
...
def twilio(request):
    if request.method == 'POST':
        ...
        return HttpResponseRedirect('/serviceApp/api/')
    return render(request, 'serviceApp/twilio.html')
...
def register(request):
    ...
    if request.method == 'POST':
        ...
        if user_form.is_valid():
            ...
            user.save()
            registered = True
            return HttpResponseRedirect('/serviceApp/login/')
        else:
